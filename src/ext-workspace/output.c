...
/* Internal API*/
void
ext_group_output_send_initial_state(struct dwl_ext_workspace_group *group,
		struct wl_resource *group_resource)
{
	struct group_output *group_output;
...
/* Public API */
void
dwl_ext_workspace_group_output_enter(struct dwl_ext_workspace_group *group,
		struct wlr_output *wlr_output)
{
	struct group_output *group_output;
	wl_list_for_each(group_output, &group->outputs, link) {
...
void
dwl_ext_workspace_group_output_leave(struct dwl_ext_workspace_group *group,
		struct wlr_output *wlr_output)
{
